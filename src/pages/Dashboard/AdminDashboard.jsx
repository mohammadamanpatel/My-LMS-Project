...
const AdminDashboard = () => {
    ...
    console.log("allUsersCount,subscribedUsersCount", allUsersCount, subscribedUsersCount);
    const userData = {
    ...
    async function onCourseDelete(id) {
        console.log("id in onCourseDelete handler",id);
                                    ...
                                    <tr key={course._id}>
                                        ...
                                        <td className="flex items-center gap-4">
                                            <button
                                                ...
                                                onClick={() => navigate("/course/showLectures", { state: { ...course } })}
                                            >
